  ...
  AxelDownloader.prototype.download = function(address, options) {
    ...
    var logPath = (typeof options.logPath !== 'undefined')? options.logPath : options.cwd;
    ...
    var command = this.child_process.spawn(options.axel, ['-avn ' + options.axelConnections, '-o ' + options.file, address], {
      'cwd'       : options.cwd, 
      'env'       : process.env,
      'detached'  : true,
